...
def login_page():
    return rx.box(
        ...
        width="100%",
        height="100vh",
        background_image="url('https://images.unsplash.com/photo-1684957691800-502e754ea1e5?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
        background_size="cover",
        background_position="center",
        position="relative",
        # 👇 ESTO ES LO QUE TE FALTABA PARA CENTRAR EN Y
        display="flex",
